...
async def list_items_route(
    ...
    log_audit_event(user_id=user_id, action="list", resource_type="item", resource_id="*")
...
async def create_item_route(
    ...
    log_audit_event(user_id=user_id, action="create", resource_type="item", resource_id=item.id)
...
async def get_item_route(
    ...
    log_audit_event(user_id=user_id, action="read", resource_type="item", resource_id=item_id)
    return ItemResponse.model_validate(item)
...
async def update_item_route(
    ...
    log_audit_event(user_id=user_id, action="update", resource_type="item", resource_id=item_id)
    return ItemResponse.model_validate(item)
...
async def delete_item_route(
    ...
    log_audit_event(user_id=user_id, action="delete", resource_type="item", resource_id=item_id)
